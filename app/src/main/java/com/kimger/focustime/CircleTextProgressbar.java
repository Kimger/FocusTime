...
public class CircleTextProgressbar extends TextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mArcRect.set(bounds.left + deleteWidth / 3, bounds.top + deleteWidth / 3, bounds.right - deleteWidth / 3, bounds.bottom - deleteWidth / 3);
        float baifen = (float) progress / (float) maxProgress * 100;
        canvas.drawArc(mArcRect, 270, ((float) progress / (float) maxProgress) * 360f, false, mPaint);
    }
